...
抄袭行为：倒扣2倍本次作业分数并根据学校有关规定严肃处理，判定标准课程组保有全部解释权。【严禁代码与博客等一切形式的抄袭！博客园支持对博客的查重功能，我们也有专门的代码审查系统进行代码查重。请各位同学不要触碰底线，勿谓言之不预也！】
评分时按照所选的软件产品进行分类评分。同一类产品分析中，会按照优秀、良好、中等、较差进行分级给分。
基于上一条，对于已经有大量人选的题目，如果分析没有出彩之处，将会大幅度影响得分，请选题时务必充分考虑。
以上全部规则和标准归北京航空航天大学计算机学院本科敏捷软件工程课程组所有。
